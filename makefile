...
assembly_source_files := boot.asm multiboot_header.asm io.asm
...
$(kernel): $(assembly_object_files) $(c_object_files) $(linker_script)
	ld -m elf_i386 -n -static -T $(linker_script) -o $(kernel) $(assembly_object_files) $(c_object_files)
